...
class PagesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "shows logout button in the shared top-right settings menu" do
    ...
    assert_response :success
    assert_select "form.button_to[action='#{destroy_user_session_path}'] button.app-settings-menu__logout.logout-btn[aria-label='Log out'][title='Log out']", text: /Log out/
