module EventImporters
  class LeagueOfLegendsEventImporter
    Result = Struct.new(:imported, :skipped, keyword_init: true)

    GAME_SLUGS = ["league-of-legends"].freeze
    GAME_NAMES = ["League of Legends"].freeze

    def call(replace: false)
      game = find_game
      raise ActiveRecord::RecordNotFound, "League of Legends game not found" if game.nil?

      all_results = EventScrapers::LeagueOfLegendsEventScraper.new.call
