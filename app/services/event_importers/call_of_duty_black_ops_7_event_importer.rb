module EventImporters
  class CallOfDutyBlackOps7EventImporter
    Result = Struct.new(:imported, :skipped, keyword_init: true)

    GAME_SLUGS = ["call-of-duty-black-ops-7"].freeze
    GAME_NAMES = ["Call of Duty: Black Ops 7", "Call of Duty Black Ops 7"].freeze

    def call(replace: false)
      game = find_game
      raise ActiveRecord::RecordNotFound, "Call of Duty: Black Ops 7 game not found" if game.nil?

      all_results = EventScrapers::CallOfDutyBlackOps7EventScraper.new.call
