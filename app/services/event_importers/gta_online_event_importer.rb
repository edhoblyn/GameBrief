module EventImporters
  class GtaOnlineEventImporter
    Result = Struct.new(:imported, :skipped, keyword_init: true)

    GAME_SLUGS = ["gta-5-online", "grand-theft-auto-online", "gta-online"].freeze
    GAME_NAMES = ["GTA 5: Online", "GTA Online", "Grand Theft Auto Online"].freeze

    def call(replace: false)
      game = find_game
      raise ActiveRecord::RecordNotFound, "GTA 5: Online game not found" if game.nil?

      all_results = EventScrapers::GtaOnlineEventScraper.new.call
