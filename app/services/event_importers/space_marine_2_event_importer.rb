module EventImporters
  class SpaceMarine2EventImporter
    Result = Struct.new(:imported, :skipped, keyword_init: true)

    GAME_SLUGS = ["warhammer-40000-space-marine-ii", "space-marine-2"].freeze
    GAME_NAMES = ["Warhammer 40,000: Space Marine II", "Warhammer 40,000: Space Marine 2"].freeze

    def call(replace: false)
      game = find_game
      raise ActiveRecord::RecordNotFound, "Space Marine 2 game not found" if game.nil?

      all_results = EventScrapers::SpaceMarine2EventScraper.new.call
