module PatchImporters
  class StarWarsBattlefront2Importer
    ...
    def call
      game = find_game
      raise ActiveRecord::RecordNotFound, "Star Wars Battlefront II game not found" if game.nil?

      results = Scrapers::StarWarsBattlefront2Scraper.new.call
      imported = 0
      skipped = 0
