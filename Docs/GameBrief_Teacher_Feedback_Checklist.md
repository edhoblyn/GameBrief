...
- [ ] Add « All games » label above the filters
- [ ] Make the search bar bigger and the search button thinner
- [ ] Move the 3 last filter buttons to the right side

## Game Show Page

- [ ] Investigate the Marvel Rivals patch bug
- [ ] Remove the space between the filters and the patches list
- [ ] Add purple outline on patch card hover
- [ ] Switch the event show to a modal

## Patch Show Page

- [ ] Chatbot placeholder: « What changed for snipers? » + mascot image
- [ ] Add accordion arrow on the right side of the card

## Events Index

- [ ] Remove the top div (« All Events » heading + sentence)
- [ ] Match the layout to the Games Index (same element alignment — calc-based grid)

## Event Show Page

- [ ] Add a back button to return to Events
- [ ] Add more space between the content and the navbar
...
- [ ] Consistency on the back button across the whole app
